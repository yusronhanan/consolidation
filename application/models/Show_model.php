  ...
  //   }
    ...
    public function editAkuisisi1(){
      ...
      $data=array(
            ...
            'pt_anak' => $this->input->post('pt_anak'),
            'tgl_akuisisi' => $this->input->post('tgl_akuisisi'),
            'persen_akuisisi' => $this->input->post('persen_akuisisi'),
            //'' => $this->input->post(''),
            );
      $this->db->where('id_akuisisi',$id)
                 ->update('akuisisi', $data);
    ...
    public function editAkuisisi2(){
      ...
      $data=array(
            ...
            'nilai_par' => $this->input->post('nilai_par'),
